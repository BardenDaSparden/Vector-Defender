...
//
//	/**
//	 * All keys are taken directly from Keyboard.java in LWJGL
//	 */
//	
...
//		
//		mouseVelocity.x = Mouse.getDX();
//		mouseVelocity.y = Mouse.getDY();
//		
//	}
//	
...
//		return isMouseButtonDown(button) && !previousButtons[button];
//	}
//	
...
//	
//	/**
//	 * @return Returns the X position of the Mouse in screen space around the origin(0, 0) as the center of the screen.
//	 */
//	public float getMouseX(){
//		return (float)Mouse.getX() / ((float)Window.getWidth() / 2) - 1;
//	}
//	
//	/**
//	 * @return Returns the Y position of the Mouse in screen space around the origin(0, 0) as the center of the screen.
//	 */
//	public float getMouseY(){
//		return (float)Mouse.getY() / ((float)Window.getHeight() / 2) - 1;
//	}
//	
...
//		//return mousePosition.y - previousMousePosition.y;
//		return mouseVelocity.y;
//	}
//	
//	public float getMouseDWheel(){
